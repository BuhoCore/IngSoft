...
public class GestorCompras {
	...
	public GestorCompras() throws IOException {
        ...
        try {
			...
			miReporteNS = mapper.readValue(new FileInputStream("C:\\Users\\grexc\\GitHub\\IngSoft\\ComprasProy-master\\arregloItemsV1.json"), ListaReportesNivelStock.class );
        ...
        for (Entry<Integer, HashMap<Integer, ArrayList<InfoComprasUIA>>> item : miComprador.getVendedores().entrySet())
        {
            int iVendedor = item.getKey();
             ...
             mapper.writeValue(new File("C:\\Users\\grexc\\GitHub\\IngSoft\\ComprasProy-master\\vendedor-"+iVendedor+".json"), nodo);
        }
